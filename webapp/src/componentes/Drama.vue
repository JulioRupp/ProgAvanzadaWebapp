<template>
  <div>
    <ul id = "drama" v-if= "peliculas != null">
...
export default {
  ...
  methods:{
    getDrama(){
      var self = this;
      axios.get('https://api.themoviedb.org/3/discover/movie?api_key=30fbf69bcba73c04a88c618b6ff8a081&with_genres=18&sort_by=vote_average.desc&vote_count.gte=10')
...
#drama{
  background-image: url("FondoDrama.jpg");
