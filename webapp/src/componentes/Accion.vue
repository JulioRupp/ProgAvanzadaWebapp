<template>
  <div>
    <ul id = "accion" v-if= "peliculas != null">
...
export default {
  ...
  methods:{
    getAccion(){
      var self = this;
      axios.get('https://api.themoviedb.org/3/discover/movie?api_key=30fbf69bcba73c04a88c618b6ff8a081&with_genres=28&sort_by=vote_average.desc&vote_count.gte=10')
...
#accion{
  background-image: url("FondoAccion.jpg");
