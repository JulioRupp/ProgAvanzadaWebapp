<template>
  <div>
    <ul id = "animada" v-if= "peliculas != null">
...
export default {
  ...
  methods:{
    getAnimada(){
      var self = this;
      axios.get('https://api.themoviedb.org/3/discover/movie?api_key=30fbf69bcba73c04a88c618b6ff8a081&with_genres=16&sort_by=vote_average.desc&vote_count.gte=10')
...
#animada{
  background-image: url("FondoAnimada.jpg");
